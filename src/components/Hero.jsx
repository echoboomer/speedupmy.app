    ...
    <Container className="pt-20 pb-16 text-center lg:pt-32">
      <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
        ...
        <span className="relative whitespace-nowrap text-blue-600">
          <svg
            ...
            className="absolute top-2/3 left-0 h-[2.58em] w-full fill-blue-300/20"
      ...
      <div>
        <p className="relative mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-900">
          Application performance is important.
          What&apos;s the <i>easiest</i> way to make your application faster?
